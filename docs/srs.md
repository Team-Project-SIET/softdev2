# 📋 Software Requirements Specification 1.1
...
**ปัญหาที่แก้:** 
มีข้อจำกัดเรื่องรถ : รถกระบะหรือรถหกล้อแต่ละคันรับน้ำหนักได้อย่างจำกัด ปกติคนจัดคิวมักจะคาดคะเนพื้นที่เอง ทำให้รถบางคันของล้น รถบางคันแทบจะไม่มีสินค้า ทำให้สิ้นเปลือง

มีข้อจำกัดเรื่องเวลา : ตัวอย่างเช่น ลูกค้า A บังคับส่งก่อน 10 โมง ลูกค้า B ห้ามรถขนาดใหญ่เข้าช่วงบ่าย คนจัดคิวรถ (ที่เป็นมนุษย์) คำนวณไม่ทัน พอส่งสินค้าเลยเวลาก็โดนลูกค้าตำหนิ หรือร้านหักเงิน
